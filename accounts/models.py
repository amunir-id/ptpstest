...
class UserSaksiTps(models.Model):
    caleg = models.ForeignKey(
        User, related_name="caleg", on_delete=models.SET_NULL, null=True
    )
    user = models.OneToOneField(
        User, on_delete=models.SET_NULL, null=True, limit_choices_to={"role": 2}
    )
...
class UserCaleg(models.Model):
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, unique=True, limit_choices_to={"role": 2}
    )
    provinsi = models.ForeignKey(Provinsi, on_delete=models.SET_NULL, null=True)
    kabkota = models.ForeignKey(KabKota, on_delete=models.SET_NULL, null=True)
    dapil = models.ForeignKey(DapilDprdKabKota, on_delete=models.SET_NULL, null=True)
